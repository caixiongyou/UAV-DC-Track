...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='lightfc', help='training script name')
    parser.add_argument('--config', type=str, default='mobilnetv2_p_pwcorr_se_scf_sc_iab_sc_adj_concat_repn33_se_conv33_center_wiou', help='yaml configure file name')
    parser.add_argument('--save_dir', type=str,default=' E:/LightFC-main',help='root directory to save checkpoints, logs, and tensorboard')
